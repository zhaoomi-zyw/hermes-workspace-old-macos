...
FUNDS = {
    "018043": ("天弘纳斯达克100指数(QDII)A", 100, "天弘——若仍暂停则关闭定投"),
    "019736": ("宝盈纳斯达克100指数发起(QDII)A", 200, "宝盈——继续定投，重点监控"),
    "005698": ("华夏全球科技先锋混合(QDII)A", 150, "华夏——正常"),
}
...
def main():
    ...
    for code, (name, amt, note) in FUNDS.items():
        ...
        lines.append("")
    lines.append("合计日定投 450 元（天弘100 + 华夏150 + 宝盈200）")
    print("\n".join(lines))
